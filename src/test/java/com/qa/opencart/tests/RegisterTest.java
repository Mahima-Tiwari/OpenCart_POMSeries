...
public class RegisterTest extends BaseTest{
	...
	public void userRegisterTest(String firstName, String lastName, String email, String telephone, 
			String password, String subscribe) {
		
		Assert.assertTrue(regPage.userRegistration(firstName, lastName, getRandomEmailId(), telephone, 
				password, subscribe));
